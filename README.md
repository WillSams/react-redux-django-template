# React /w Redux Toolkit + Django Ninja Template

**React · Material UI · Redux Toolkit · Django Ninja · AWS ECS Fargate · Terraform**

[![Application Unit Tests](https://github.com/WillSams/react-redux-django-template/actions/workflows/pr-validate.yml/badge.svg)](https://github.com/WillSams/react-redux-django-template/actions/workflows/pr-validate.yml)
...
See also the [useReducer template](https://github.com/WillSams/react-usereducer-django-template) for a zero-dependency state approach, and the [Zustand template](https://github.com/WillSams/react-zustand-django-template) for a lighter-weight store without Redux boilerplate.
...
|---|---|---|
| `VITE_API_URL` | *(unset — uses Vite proxy)* | Your ALB URL |
